...
- comparer avec d'autres modèles de lave-linge ({% test machine-a-laver-miele modèles haut de gamme %}, {% test machine-a-laver-laden modèles plus anciens %}) pour voir ce qui est universel et ce qui est spécifique au modèle testé ici.
