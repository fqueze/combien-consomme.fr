...
La consommation en attente est faible : {{ 1.69 | W }} en moyenne. D'après le manuel, la machine s'éteindrait automatiquement après 9 minutes dans cet état.

Si la machine restait en attente pendant 9 minutes, elle consommerait {{ 1.69 | times: 540 | divided_by: 3600 | Wh }} supplémentaires.
